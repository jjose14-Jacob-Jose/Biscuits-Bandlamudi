...
public class ThemeHelp extends UniversalHelp {

	@Override
	public void executeChild(V2_AsciiTable at) {

		at.addRow(null, "Theme Commands").setAlignment(new char[] { 'c', 'c' });
		at.addRule();
		at.addRow("show", "Show Theme information").setAlignment(new char[] { 'l', 'l' });
		at.addRow("edit", "Theme epic").setAlignment(new char[] { 'l', 'l' });
