...
public class ThemeCompleterFactory {

	public static Collection<? extends Completer> getThemeCompleters(Theme theme) {
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("go_to"), new StringsCompleter(UserStories.getAllNames(theme)), new NullCompleter()));
